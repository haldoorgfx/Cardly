...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Custom domain (cards.yourbrand.com)",
...
const COMPARISON_GROUPS = [
  {
    title: "Campaigns",
    rows: [
      ["Active events", "1", "5", "Unlimited"],
      ["Cards per event", "50", "Unlimited", "Unlimited"],
      ["Variants per event", "1", "3", "Unlimited"],
  ...
  },
  {
    ...
    rows: [
      ...
      ["Multi-language form (EN / FR / AR / SW)", false, true, true],
      ["Card download as PNG", true, true, true],
      ["Card download as video (animated)", false, false, true],
    ],
  },
  {
    title: "Analytics",
...
function PricingFAQ() {
  const items = [
    ...
    {
      q: "What happens to my cards if I downgrade?",
      a: "Cards already generated stay live forever — your attendees can always re-download what they made. New cards generated after a downgrade follow the limits of the new plan.",
    },
    {
    ...
    {
      q: "What's a 'card'? Does each download count?",
      a: "One card = one attendee submitting the form and downloading their personalized version. If the same attendee re-downloads, that's still one card. We count unique generations, not file taps.",
    },
    {
      q: "Can I pay annually by bank transfer or mobile money?",
      a: "Yes. Studio annual plans accept SWIFT bank transfer (USD/EUR/GBP), M-Pesa, MTN MoMo, and Paystack. Email billing@cardly.app to set it up.",
    },
    {
