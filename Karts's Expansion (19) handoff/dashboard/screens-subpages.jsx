  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h1 className="font-title text-[24px] font-semibold text-primary tracking-[-0.025em]">Registrations</h1>
...
function Agenda({ event }) {
  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h1 className="font-title text-[24px] font-semibold text-primary tracking-[-0.025em]">Agenda</h1>
