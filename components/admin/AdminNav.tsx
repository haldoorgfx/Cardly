...
import { Palette, BookOpen, ScrollText, Users, LayoutGrid, Layers, Ticket } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-3 py-5 space-y-0.5">
        <div className="px-2 mb-3 text-[12px] text-white/25 uppercase tracking-widest">
          Platform
        </div>
