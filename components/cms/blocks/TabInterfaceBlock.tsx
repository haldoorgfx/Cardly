          ...
          <div className="space-y-4">
            {tab.problems && tab.problems.length > 0 && (
              <div className="rounded-2xl border border-[#E5E0D4] overflow-hidden bg-white p-5">
                <div className=" text-[10px] tracking-[0.18em] uppercase text-[#65736B] mb-4">Problems solved</div>
            ...
            {tab.examples && tab.examples.length > 0 && (
              <div className="rounded-2xl border border-[#E5E0D4] overflow-hidden bg-white p-5">
                <div className=" text-[10px] tracking-[0.18em] uppercase text-[#65736B] mb-4">Examples</div>
                <ul className="space-y-2">
                  {tab.examples.map((ex, ei) => (
                    <li key={ei} className="flex items-center justify-between">
                      ...
                      {ex.role && (
                        <span className="text-[11px] text-[#65736B] bg-[#FAF6EE] px-2 py-0.5 rounded-full">{ex.role}</span>
                      )}
                    </li>
                  ))}
                </ul>
