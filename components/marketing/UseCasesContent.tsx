...
const USE_CASES: UseCase[] = [
  {
    ...
    intro:
      'Conferences are won on the timeline. Eventera turns your speaker grid, sponsor deck, and ticket-holder list into 2,000 individual posts — each on-brand, each personal.',
    cards: [
    ...
    quote: { text: "We sent 1,800 speakers an Eventera link and saw 1,400 posts in the first 48 hours. The hashtag trended in three cities.", who: 'Festival Producer · Africa Tech Festival' },
  ...
  },
  {
    ...
    headline: 'Awareness needs faces. Eventera gives every supporter one.',
    intro:
      'When the cause matters, the people backing it should be visible. Eventera cards turn donors, volunteers and supporters into a wall of branded portraits.',
    cards: [
  ...
  },
  {
    ...
    intro:
      'Rallies. Endorsements. Voter mobilization. Each requires a different card — same brand, different message. Eventera variants do exactly that.',
    cards: [
    ...
    quote: { text: "We shipped one Eventera link per region. 22 regions, 22 variants — and the central comms team didn't have to design any of them.", who: 'Field Director · East Africa Campaign' },
  ...
  },
  {
    ...
    intro:
      "Mosques, churches, temples, fellowships. Eventera cards let members announce attendance, fundraising and registration — without leaving WhatsApp.",
    cards: [
  ...
  },
  {
    ...
    intro:
      "Product launches, store openings, sponsorships. Eventera turns the people excited about your brand into the people advertising your brand.",
    cards: [
    ...
    quote: { text: "We had 4,500 customers post an Eventera card in launch week. Our paid media team called it the cheapest UGC engine they've ever bought.", who: 'CMO · Pan-African Fintech' },
  ...
  },
  {
    ...
    intro:
      "Schools and universities sit on the best UGC moments in the calendar — and almost never harvest them. Eventera is how you turn graduations and class reunions into reach.",
    cards: [
    ...
    quote: { text: "We launched Eventera with our December graduation. 60% of graduates posted a card. The alumni office is calling it the most-engaged campaign in a decade.", who: 'Director of Communications · University of Nairobi' },
