            ...
            <div className="flex items-center gap-2.5 mt-6">
              ...
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 grid place-items-center rounded-full border transition-colors hover:bg-cream/10 hover:border-cream/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E8C57E] focus-visible:ring-offset-2 focus-visible:ring-offset-[#163828]"
