    ...
    <div className="max-w-[1000px] mx-auto px-6 py-8">
      ...
      <div className="flex items-start justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 h-9 px-4 rounded-lg text-white text-[13px] font-semibold transition hover:opacity-90 disabled:opacity-50"
          style={{ background: '#1F4D3A' }}
        >
      ...
      <div className="rounded-2xl overflow-hidden mb-4" style={{ border: '1px solid #E5E0D4', background: 'white' }}>
        ...
        {/* Confirmation email row — always present */}
