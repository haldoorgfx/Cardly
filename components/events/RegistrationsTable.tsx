      ...
      <div className="relative bg-white rounded-2xl overflow-hidden w-full max-w-[420px]" style={{ border: '1px solid #E5E0D4', boxShadow: '0 8px 40px rgba(15,31,24,0.18)' }}>
        <div className="flex items-center justify-between px-6 py-5" style={{ borderBottom: '1px solid #E5E0D4' }}>
          <div>
            ...
            <p className="text-[12.5px] mt-0.5" style={{ color: '#65736B' }}>Update registration details</p>
          </div>
          <button onClick={onClose} className="h-10 w-10 rounded-lg grid place-items-center hover:bg-[#F5F3EE]" style={{ color: '#65736B' }}>
        ...
        <div className="px-4 sm:px-6 py-5 space-y-4">
          ...
          <div>
            <label className="block text-[12.5px] uppercase tracking-widest mb-1.5" style={{ color: errors.name ? '#B8423C' : '#65736B' }}>Full name *</label>
            <input
          ...
          <div>
            <label className="block text-[12.5px] uppercase tracking-widest mb-1.5" style={{ color: errors.email ? '#B8423C' : '#65736B' }}>Email *</label>
            <input
          ...
          <div>
            <label className="block text-[12.5px] uppercase tracking-widest mb-1.5" style={{ color: '#65736B' }}>Phone (optional)</label>
            <input
          ...
          {ticketTypes.length > 0 && (
            <div>
              <label className="block text-[12.5px] uppercase tracking-widest mb-1.5" style={{ color: '#65736B' }}>Ticket type</label>
              <select
        ...
        <div className="px-4 sm:px-6 pb-5 pt-3 flex gap-3" style={{ borderTop: '1px solid #F0EBE3' }}>
          <button onClick={onClose} className="flex-1 h-10 rounded-lg text-[13px] font-medium border transition" style={{ borderColor: '#E5E0D4', color: '#65736B' }}>
            Cancel
          </button>
          <button
  ...
  return (
    <div className="relative flex items-center justify-end gap-1.5">
      ...
      <button
        ...
        disabled={loading}
        className="w-10 h-10 rounded-lg grid place-items-center transition-colors hover:bg-[#F0EBE3]"
        style={{ color: loading ? '#C9C3B1' : '#65736B' }}
        title="Actions"
      >
      ...
      {open && menuPos && createPortal(
        ...
        >
          ...
          <button
            ...
            style={{ color: '#0F1F18' }}
          >
            <Pencil size={12} strokeWidth={2} style={{ color: '#65736B' }} /> Edit attendee
          </button>
          ...
          {canUndoCheckIn && (
            <button onClick={() => changeStatus('confirmed')} className="w-full text-left px-4 py-2 text-[13px] hover:bg-[#F5F3EE] transition-colors flex items-center gap-2.5" style={{ color: '#65736B' }}>
      ...
      <div className="relative bg-white rounded-2xl overflow-hidden w-full max-w-[560px] max-h-[90vh] flex flex-col" style={{ border: '1px solid #E5E0D4', boxShadow: '0 8px 40px rgba(15,31,24,0.18)' }}>
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-5 shrink-0" style={{ borderBottom: '1px solid #E5E0D4' }}>
          <div>
            ...
            <p className="text-[12.5px] mt-0.5" style={{ color: '#65736B' }}>Bulk-add attendees from a spreadsheet export</p>
          </div>
          <button onClick={onClose} className="h-10 w-10 rounded-lg grid place-items-center hover:bg-[#F5F3EE]" style={{ color: '#65736B' }}>
            <X size={14} strokeWidth={2.2} />
          </button>
        ...
        <div className="px-4 sm:px-6 py-5 overflow-y-auto space-y-4 flex-1">
          ...
          {!result && (
            <>
              ...
              {/* Format hint */}
              <div className="rounded-xl px-4 py-3 text-[12px]" style={{ background: '#F5F3EE', color: '#65736B' }}>
                      ...
                      <thead style={{ background: '#FAF6EE', position: 'sticky', top: 0 }}>
                        <tr>
                          {['Name', 'Email', 'Phone', ''].map(h => (
                            <th key={h} className="px-3 py-2  text-[11.5px] uppercase tracking-wider" style={{ color: '#65736B' }}>{h}</th>
                          ))}
                        </tr>
                      </thead>
                      <tbody>
                        {rows.slice(0, 100).map((r, i) => (
                          <tr key={i} style={{ background: r.error ? '#FFF7F7' : i % 2 === 0 ? 'white' : '#FAF6EE', borderTop: '1px solid #F0EBE3' }}>
                            ...
                            <td className="px-3 py-2 text-[12px]" style={{ color: '#65736B' }}>{r.email || <span style={{ color: '#B8423C' }}>—</span>}</td>
              ...
              {ticketTypes.length > 0 && (
                <div>
                  <label className="block text-[12.5px] uppercase tracking-widest mb-1.5" style={{ color: '#65736B' }}>Assign ticket type (optional)</label>
                  <div className="relative">
                    ...
                    <ChevronDown size={13} className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: '#65736B' }} />
                  </div>
                </div>
              )}
            </>
      ...
      <div className="relative bg-white rounded-2xl overflow-hidden w-full max-w-[420px]" style={{ border: '1px solid #E5E0D4', boxShadow: '0 8px 40px rgba(15,31,24,0.18)' }}>
        ...
        <div className="flex items-center justify-between px-6 py-5" style={{ borderBottom: '1px solid #E5E0D4' }}>
          <div>
            ...
            <p className="text-[12.5px] mt-0.5" style={{ color: '#65736B' }}>Walk-in or offline registration</p>
          </div>
          <button onClick={onClose} className="h-10 w-10 rounded-lg grid place-items-center hover:bg-[#F5F3EE]" style={{ color: '#65736B' }}>
            <X size={14} strokeWidth={2.2} />
          </button>
        ...
        <div className="px-4 sm:px-6 py-5 space-y-4">
          ...
          <div>
            <label className="block text-[12.5px] uppercase tracking-widest mb-1.5" style={{ color: errors.ticketId ? '#B8423C' : '#65736B' }}>Ticket type {ticketTypes.length > 0 ? '*' : '(optional)'}</label>
            {ticketTypes.length === 0 ? (
      ...
      <div className="relative bg-white rounded-2xl overflow-hidden w-full max-w-[600px] max-h-[80vh] flex flex-col" style={{ border: '1px solid #E5E0D4', boxShadow: '0 8px 40px rgba(15,31,24,0.18)' }}>
        <div className="flex items-center justify-between px-6 py-4 shrink-0" style={{ borderBottom: '1px solid #E5E0D4' }}>
          <div>
            ...
            <p className="text-[12px] mt-0.5" style={{ color: '#65736B' }}>AI-generated report, ready to share with stakeholders</p>
          </div>
...
export function RegistrationsTable({ eventId, eventSlug, initialRegistrations, totalCount, ticketTypes, formFields = [], cardEmails = [], totalCardsGenerated, serverCheckedInCount, serverPendingCount, serverRevenueByCurrency, plan = 'free', eventName }: Props) {
  ...
  return (
    <div>
        ...
        {[
          ...
          <div key={s.label} className="flex items-center gap-5">
            <div>
              ...
              <span className="ml-2 text-[13px]" style={{ color: '#65736B' }}>{s.label}</span>
            </div>
          ...
          {(['all', 'confirmed', 'checked_in', 'pending', 'pending_approval', 'cancelled', 'refunded'] as const).map(s => (
            <button
              ...
              style={{
                ...
                color: statusFilter === s ? 'white' : '#65736B',
      ...
      {selected.size > 0 && (
        <div className="flex flex-wrap items-center gap-2 mb-3 px-4 py-2.5 rounded-xl" style={{ background: '#E8EFEB', border: '1px solid rgba(31,77,58,0.25)' }}>
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <button onClick={clearSelection} disabled={bulkBusy} className="text-[12.5px] font-medium px-2 transition hover:underline disabled:opacity-50" style={{ color: '#65736B' }}>
              Clear
            </button>
          </div>
        </div>
              ...
              <thead>
                <tr style={{ background: '#FAF6EE', borderBottom: '1px solid #E5E0D4' }}>
                  ...
                  {['Name', 'Ticket', 'Amount', 'Status', 'Card', 'Registered', 'Checked in', ''].map(h => (
                    <th key={h} className="px-5 py-3  text-[12px] tracking-[0.12em] uppercase font-semibold whitespace-nowrap" style={{ color: '#65736B' }}>
                      {h}
                    </th>
                  ))}
                </tr>
                ...
                {rows.map((reg, i) => (
                  <tr key={reg.id} style={{ background: selected.has(reg.id) ? '#F0F7F3' : i % 2 === 0 ? 'white' : '#FAF6EE', borderBottom: '1px solid #F0EBE3' }}>
                    ...
                    <td className="px-5 py-3.5">
                      ...
                      <div className="text-[12px]" style={{ color: '#65736B' }}>{reg.attendee_email}</div>
                    </td>
                    ...
                    <td className="px-5 py-3.5  text-[12px] whitespace-nowrap" style={{ color: '#65736B' }}>
                ...
                <div key={reg.id} className="p-4" style={{ background: selected.has(reg.id) ? '#F0F7F3' : 'white' }}>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-[12px] truncate" style={{ color: '#65736B' }}>{reg.attendee_email}</div>
                    </div>
                    <RowActionsMenu
                      reg={reg}
                      eventId={eventId}
      ...
      {loading && rows.length > 0 && (
        <div className="mt-4 text-center text-[13px]" style={{ color: '#65736B' }}>Loading…</div>
      )}
    </div>
  );
}
