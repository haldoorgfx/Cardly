      ...
      <DetailHeader onBack={onBack} parent="Registrations">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="font-display text-[24px] font-semibold text-primary tracking-[-0.02em] leading-tight">{a.name || "Aisha Ahmed"}</h1>
    ...
    <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8" style={{ maxWidth: "1100px" }}>
      <DetailHeader onBack={onBack} parent="Speakers">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="font-display text-[24px] font-semibold text-primary tracking-[-0.02em] leading-tight">{s.name || "Kwame Mensah"}</h1>
            <div className="flex items-center gap-2 flex-wrap mt-2">
      ...
      <DetailHeader onBack={onBack} parent="Sessions">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <h1 className="font-display text-[24px] font-semibold text-primary tracking-[-0.02em] leading-tight">{s.title || "Scaling fintech across borders"}</h1>
    ...
    <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8" style={{ maxWidth: "1100px" }}>
      <DetailHeader onBack={onBack} parent="Sponsors">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="font-display text-[24px] font-semibold text-primary tracking-[-0.02em] leading-tight">{s.n || "Paystack"}</h1>
            <div className="flex items-center gap-2 flex-wrap mt-2">
    ...
    <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8" style={{ maxWidth: "1100px" }}>
      <DetailHeader onBack={onBack} parent="Users">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="font-display text-[24px] font-semibold text-primary tracking-[-0.02em] leading-tight">{u.n || "Samuel Adeyemi"}</h1>
            <div className="flex items-center gap-2 flex-wrap mt-2">
