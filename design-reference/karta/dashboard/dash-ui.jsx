  ...
  return (
    <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8" style={{ maxWidth: max }}>
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4 mb-6">
        <div>
          <h1 className="font-display text-[22px] sm:text-[24px] font-semibold text-primary tracking-[-0.02em]">{title}</h1>
...
function NotFound({ item, onBack }) {
  return (
    <div className="mx-auto px-8 py-20 max-w-[560px] text-center">
      ...
      <h1 className="font-display text-[26px] font-semibold text-primary tracking-[-0.02em]">Page not found</h1>
