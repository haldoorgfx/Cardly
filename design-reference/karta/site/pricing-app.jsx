    ...
    <section className="relative overflow-hidden border-b border-border">
      ...
      <div className="relative mx-auto max-w-[1100px] px-5 lg:px-10 pt-16 lg:pt-24 pb-10 lg:pb-14 text-center">
        <div className="inline-flex items-center gap-2 bg-surface/80 border border-primary/15 rounded-full pl-2.5 pr-3.5 py-1.5 mb-7 shadow-sm">
          <span className="inline-flex items-center gap-1.5 font-mono text-[10px] tracking-[0.14em] uppercase text-primary"><span className="w-1.5 h-1.5 rounded-full bg-accent" /> Pricing</span>
          <span className="w-px h-3.5 bg-border" />
          <span className="font-sans text-[12.5px] font-medium text-ink-soft">Free to start · scales with you</span>
        </div>
        ...
        <div className="mt-12 flex flex-col items-center gap-5">
          <span className="font-mono text-[10px] tracking-[0.2em] uppercase text-muted">Trusted by teams running world-class events</span>
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4">
            {["Paystack", "MTN Group", "UNDP", "Andela", "Flutterwave"].map((l, i) => (
              <span key={i} className="font-display font-bold text-[16px] sm:text-[18px] tracking-tight text-primary/35">{l}</span>
            ))}
          </div>
        </div>
      </div>
