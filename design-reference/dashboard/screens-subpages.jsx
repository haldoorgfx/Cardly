...
function Avatar({ initials, grad }) {
  return (
    <span className="w-8 h-8 rounded-full grid place-items-center text-cream font-display text-[11px] font-semibold shrink-0" style={{ background: grad }}>
      {initials}
    </span>
  );
}
    ...
    <div className="max-w-[1100px] mx-auto px-8 py-8">
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-2">
          <button className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg border border-border text-ink-soft text-[13px] hover:border-primary/40 hover:text-primary transition-colors">
      ...
      <div className="bg-surface border border-border rounded-2xl overflow-hidden">
        <table className="w-full text-left">
          ...
          <tbody>
            {rows.map((r, i) => (
              <tr key={i} className="border-t border-border/60 hover:bg-cream/40 transition-colors">
