...
const PLATFORM_NAV = [
  ...
  },
  {
    ...
    requireRole: "admin",
    items: [
      { id: "admin-users", label: "Users", icon: "Users", screen: "stub" },
      { id: "admin-events", label: "All Events", icon: "Calendar", screen: "stub" },
      { id: "admin-analytics", label: "Platform Analytics", icon: "Chart", screen: "stub" },
      { id: "admin-changelog", label: "Changelog", icon: "ListChecks", screen: "stub" },
      { id: "admin-audit", label: "Audit Log", icon: "Shield", screen: "stub" },
    ],
  },
];
...
const EVENT_NAV = [
  {
    ...
    items: [
      ...
      { id: "event-page", label: "Event Page", icon: "Layout", screen: "stub" },
      { id: "tickets", label: "Tickets", icon: "Ticket", screen: "stub" },
      { id: "registrations", label: "Registrations", icon: "Users", screen: "registrations" },
      { id: "check-in", label: "Check-in", icon: "Scan", screen: "stub" },
    ],
  },
  {
    title: "Programme",
  ...
  },
  {
    title: "Insights",
    items: [
      { id: "e-analytics", label: "Analytics", icon: "Chart", screen: "stub" },
    ],
  },
];
...
const EVENT_CARDS = [
  ...
  { id: "karta-card", label: "Karta Card", icon: "IdCard", desc: "The personalized card every attendee gets", status: "201 downloaded", gold: true, screen: "stub" },
  { id: "virtual", label: "Virtual", icon: "Video", desc: "Stream sessions online", minPlan: "studio", screen: "stub" },
];
