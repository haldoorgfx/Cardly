    ...
    >
      ...
      >
        ...
        <button
          ...
          className="w-full h-10 flex items-center justify-center gap-2.5 rounded-lg border text-[14px] font-medium text-[#0F1F18] transition hover:bg-[#FAF6EE] disabled:opacity-50 mb-5"
