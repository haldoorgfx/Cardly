      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 56, flexWrap: 'wrap' as const, justifyContent: 'center', position: 'relative' as const }}>
        ...
        <div style={{ flex: '1 1 300px', maxWidth: 420, textAlign: 'left' as const }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
            ...
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: 11, fontWeight: 700, letterSpacing: '0.15em', color: '#1F4D3A', textTransform: 'uppercase' as const }}>Attendee Matching</span>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 12 }}>
            {[
              { label: 'Opt-in', desc: 'attendees choose to be listed' },
              { label: 'AI-matched', desc: 'suggested by role & interests' },
              { label: '1:1', desc: 'request & confirm meetings' },
            ].map((s) => (
        ...
        <div style={{ flex: '0 0 auto', position: 'relative' as const }}>
          ...
          <div style={{ position: 'absolute' as const, top: -16, left: 20, background: '#1F4D3A', borderRadius: 999, padding: '6px 14px', display: 'flex', alignItems: 'center', gap: 7, zIndex: 10, boxShadow: '0 4px 16px rgba(15,31,24,0.25)' }}>
            ...
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: 12, fontWeight: 600, color: '#FAF6EE' }}>412 connections made</span>
          </div>
            ...
            <div style={{ background: '#FAF6EE', display: 'flex', height: 320, overflow: 'hidden' }}>
              ...
              <div style={{ flex: 1, padding: 12, overflow: 'hidden' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                  <div style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 11, fontWeight: 700, color: '#1F4D3A' }}>Who to meet</div>
                  <div style={{ background: '#E8EFEB', borderRadius: 999, padding: '2px 8px', fontFamily: 'var(--font-sans)', fontSize: 10, color: '#1F4D3A', fontWeight: 600 }}>12 matches</div>
                </div>
                {[
                  ...
                  <div key={m.initials} style={{ background: '#FFFFFF', border: '1px solid #E5E0D4', borderRadius: 8, padding: '8px 10px', marginBottom: 6, display: 'flex', alignItems: 'center', gap: 8 }}>
                    <div style={{ width: 28, height: 28, borderRadius: '50%', background: m.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 10, fontWeight: 700, color: '#1F4D3A', flexShrink: 0 }}>{m.initials}</div>
                    ...
                    <div style={{ fontFamily: 'var(--font-sans)', fontSize: 10, fontWeight: 600, color: '#2D7A4F', flexShrink: 0 }}>{m.pct}%</div>
                  </div>
                ))}
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: 10, color: '#6B7A72', marginTop: 8, marginBottom: 5 }}>Networking feed</div>
                {[{ w: 100 }, { w: 85 }].map((r, i) => (
          ...
          <div style={{ position: 'absolute' as const, bottom: -20, right: -35, width: 150, background: '#0F1F18', borderRadius: 24, padding: 6, boxShadow: '0 8px 40px rgba(0,0,0,0.45)', zIndex: 10 }}>
            <div style={{ background: '#FAF6EE', borderRadius: 20, overflow: 'hidden' }}>
              <div style={{ background: '#1F4D3A', padding: '10px 10px 8px', display: 'flex', alignItems: 'center', gap: 6 }}>
                <div style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 10, fontWeight: 700, color: '#FAF6EE' }}>Top match</div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: 9, color: '#E8C57E', fontWeight: 700 }}>94%</div>
              </div>
              <div style={{ padding: '8px 8px 6px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}>
                  <div style={{ width: 28, height: 28, borderRadius: '50%', background: '#E8EFEB', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 10, fontWeight: 700, color: '#1F4D3A', flexShrink: 0 }}>KA</div>
                  <div>
