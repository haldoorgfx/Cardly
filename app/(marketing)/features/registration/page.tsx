              ...
              <div style={{ flex: 1, padding: 12, overflow: 'hidden' }}>
                ...
                {[
                  ...
                  <div key={i} style={{ background: '#FFFFFF', border: '1px solid #E5E0D4', borderRadius: 6, padding: '6px 8px', marginBottom: 5, display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <div style={{ fontFamily: 'var(--font-sans)', fontSize: 10, color: '#65736B', flexShrink: 0 }}>{t.pct}%</div>
                  </div>
                ))}
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: 10, color: '#65736B', marginTop: 6, marginBottom: 5 }}>Recent</div>
                {[{ w: 65 }, { w: 55 }].map((r, i) => (
