...
import { Trophy, Medal, Sunrise, Mic, Handshake, Building2 } from 'lucide-react';
...
function GamificationMockup() {
  return (
    <section style={{ background: 'linear-gradient(165deg, #1F4D3A 0%, #163828 100%)', padding: '80px 24px' }}>
      <div style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center' }}>
        {/* Header */}
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: 11, fontWeight: 600, color: '#E8C57E', letterSpacing: '0.15em', textTransform: 'uppercase' as const, marginBottom: 16 }}>ATTENDEE VIEW</p>
        <h2 style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 28, fontWeight: 700, color: '#FAF6EE', letterSpacing: '-0.02em', marginBottom: 12 }}>Friendly competition. Real engagement.</h2>
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'rgba(250,246,238,0.65)', marginBottom: 48 }}>Points update the moment they complete an action.</p>
        ...
        <div style={{ width: 300, margin: '0 auto', background: '#163828', borderRadius: 36, padding: 10, boxShadow: '0 32px 80px rgba(0,0,0,0.5)' }}>
          <div style={{ background: '#FAF6EE', borderRadius: 28, overflow: 'hidden' }}>
            ...
            <div style={{ background: '#1F4D3A', padding: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 15, fontWeight: 700, color: '#FAF6EE' }}><Trophy size={17} strokeWidth={2} color="#E8C57E" aria-hidden />Leaderboard</div>
              <div style={{ fontFamily: 'var(--font-sans)', fontSize: 11, color: 'rgba(250,246,238,0.65)', marginTop: 2 }}>Pan-African Tech Summit · Day 1</div>
              <div style={{ display: 'inline-block', background: 'rgba(255,255,255,0.12)', color: '#FAF6EE', fontFamily: 'var(--font-sans)', fontSize: 11, borderRadius: 999, padding: '4px 10px', marginTop: 10 }}>Your rank: #7 · 340 pts</div>
            </div>
            ...
            <div style={{ background: '#FFFFFF', margin: 8, borderRadius: 14, padding: 16 }}>
              ...
              {[
                ...
                { medalColor: '#C9865E', initials: 'FH', avatarBg: 'linear-gradient(135deg,#C9A45E,#E8C57E)', initialsColor: '#163828', name: 'Fatima Hassan', org: 'Lagos Startup', pts: '820 pts' },
              ].map((r, i) => (
                <div key={r.initials} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0', borderBottom: i < 2 ? '1px solid #F5F0E8' : 'none' }}>
                  <Medal size={22} strokeWidth={2} color={r.medalColor} aria-hidden style={{ flexShrink: 0 }} />
                  <div style={{ width: 40, height: 40, borderRadius: '50%', background: r.avatarBg, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <span style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 14, fontWeight: 700, color: r.initialsColor }}>{r.initials}</span>
                  </div>
            ...
            <div style={{ background: '#FAF6EE', padding: '12px 16px' }}>
              <div style={{ fontFamily: 'var(--font-sans)', fontSize: 13, fontWeight: 700, color: '#0F1F18', marginBottom: 10 }}>Your badges</div>
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' as const }}>
                {[
                  { Icon: Sunrise, label: 'Early Bird', locked: false },
                  { Icon: Mic, label: '5 Sessions', locked: false },
                  { Icon: Handshake, label: 'Networker', locked: false },
                  { Icon: Building2, label: 'Booth Hopper', locked: true },
                ].map((b) => (
    ...
    <>
      ...
      <section style={{ background: C.cream, padding: 'clamp(80px, 12vw, 140px) clamp(20px, 5vw, 80px) clamp(60px, 8vw, 100px)', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: C.primarySoft, border: `1px solid ${C.border}`, borderRadius: 999, padding: '6px 16px', marginBottom: 28 }}>
          ...
          <span style={{ fontFamily: 'var(--font-sans)', fontSize: 13, fontWeight: 500, color: C.primary, letterSpacing: '0.02em'  }}>Gamification</span>
        </div>
        <h1 style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 'clamp(36px, 6vw, 72px)', fontWeight: 700, color: C.ink, letterSpacing: '-0.02em', lineHeight: 1.1, maxWidth: 720, margin: '0 auto 24px'  }}>Turn attending into achieving.</h1>
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: 'clamp(16px, 2vw, 20px)', color: C.inkSoft, maxWidth: 600, margin: '0 auto 40px', lineHeight: 1.65 }}>Points, leaderboards, badges, and challenges that keep attendees moving, engaging, and coming back. The most-attended sessions. The most-active networkers. Recognized.</p>
      ...
      <section style={{ background: C.surface, padding: 'clamp(60px, 8vw, 100px) clamp(20px, 5vw, 80px)'  }}>
        <div style={{ maxWidth: 1100, margin: '0 auto'  }}>
          <h2 style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 'clamp(26px, 4vw, 40px)', fontWeight: 700, color: C.ink, letterSpacing: '-0.02em', textAlign: 'center', marginBottom: 12 }}>Everything you need to run a game</h2>
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: 16, color: C.muted, textAlign: 'center', maxWidth: 520, margin: '0 auto 56px'  }}>Four mechanics that work together. Attendees play, sponsors win, organizers celebrate.</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            ...
            <div style={{ background: C.cream, border: `1px solid ${C.border}`, borderRadius: 16, padding: '32px 28px'  }}>
              ...
              <h3 style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 20, fontWeight: 700, color: C.ink, marginBottom: 10 }}>Points System</h3>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: C.inkSoft, lineHeight: 1.65 }}>Earn points for checking in, attending sessions, visiting sponsor booths, submitting Q&amp;A questions, and connecting with other attendees. Organizers set the rules.</p>
            </div>
            ...
            <div style={{ background: C.cream, border: `1px solid ${C.border}`, borderRadius: 16, padding: '32px 28px'  }}>
              ...
              <h3 style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 20, fontWeight: 700, color: C.ink, marginBottom: 10 }}>Live Leaderboard</h3>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: C.inkSoft, lineHeight: 1.65 }}>A real-time leaderboard visible to all attendees. The competitive ones climb it. Everyone else sees who is most engaged — and wants in.</p>
            </div>
            ...
            <div style={{ background: C.cream, border: `1px solid ${C.border}`, borderRadius: 16, padding: '32px 28px'  }}>
              ...
              <h3 style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 20, fontWeight: 700, color: C.ink, marginBottom: 10 }}>Badges &amp; Achievements</h3>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: C.inkSoft, lineHeight: 1.65 }}>Award badges for milestones: first check-in, attended 5 sessions, visited all sponsors. Badges show on attendee profiles. They become a credential worth sharing.</p>
            </div>
            ...
            <div style={{ background: C.cream, border: `1px solid ${C.border}`, borderRadius: 16, padding: '32px 28px'  }}>
              ...
              <h3 style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 20, fontWeight: 700, color: C.ink, marginBottom: 10 }}>Sponsor Quests</h3>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: C.inkSoft, lineHeight: 1.65 }}>Create sponsored challenges. Visit the Acme booth and scan their QR for 200 points. Gives sponsors foot traffic and gives attendees a reason to explore.</p>
            </div>
      ...
      <section style={{ background: C.surface, borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}`, padding: 'clamp(48px, 6vw, 72px) clamp(20px, 5vw, 80px)'  }}>
        <div style={{ maxWidth: 860, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 40, textAlign: 'center'  }}>
          {stats.map((s) => (
            <div key={s.value}>
              <div style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 'clamp(40px, 6vw, 56px)', fontWeight: 700, color: C.primary, letterSpacing: '-0.02em', lineHeight: 1 }}>{s.value}</div>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1F4D3A 0%, #2A6A50 60%, #E8C57E 100%)', padding: 'clamp(72px, 10vw, 120px) clamp(20px, 5vw, 80px)', textAlign: 'center'  }}>
        <h2 style={{ fontFamily: 'var(--theme-font-display, "Plus Jakarta Sans"), sans-serif', fontSize: 'clamp(28px, 5vw, 52px)', fontWeight: 700, color: '#FFFFFF', letterSpacing: '-0.02em', maxWidth: 600, margin: '0 auto 20px', lineHeight: 1.15 }}>Ready to make your event unforgettable?</h2>
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: 17, color: 'rgba(255,255,255,0.8)', maxWidth: 480, margin: '0 auto 40px', lineHeight: 1.65 }}>Set up gamification in minutes. Your attendees will thank you for it.</p>
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap'  }}>
