...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'We analysed share patterns across every campaign on Eventera. Two things consistently predict whether a card gets shared or sits in a download folder.',
    readTime: '8 min read',
    body: [
      'After a quarter of a million cards generated across hundreds of events, patterns start to show. Some campaigns spread across cities; others generate cards that never leave the download folder. When we looked at what separated the two, two factors did most of the work.',
      '## One: the card has to feel like the person, not the brand',
      'Cards that led with the attendee — their photo, their name, their role — were shared at several times the rate of cards that led with the event logo. This is intuitive once you see it: people post things that say something about themselves. A card that is mostly your branding is an ad they are being asked to distribute for free. A card that is mostly them, with your brand as the frame, is a personal moment they want to share anyway.',
      '## Two: the share has to happen in the first hour',
      'The single strongest predictor of whether a card got shared was how quickly it reached the attendee after registration. Cards delivered instantly, on the confirmation screen, were shared far more than cards emailed later. Enthusiasm has a half-life. The moment right after someone commits to an event is the moment they are most excited to tell people — and most campaigns miss it entirely by waiting.',
      '## What the wide campaigns did',
      'The events that spread widest did three unglamorous things. They made the card personal. They delivered it the instant someone registered. And they gave a one-tap path to WhatsApp and Instagram Stories, where their audiences actually share. None of that is a growth hack. It is just removing every gap between the moment of excitement and the act of sharing.',
      '## The takeaway',
  ...
  },
  {
    ...
    category: 'Product',
    date: 'Mar 14, 2026',
    title: 'Eventera is now available in 8 countries',
    excerpt:
      "We quietly expanded storage regions and currency support. Here's what changed and which markets are now fully supported.",
    readTime: '3 min read',
    body: [
      'We have expanded Eventera to eight fully supported markets, with local currency handling and regional storage so that events load fast and payments feel native no matter where your attendees are.',
      '## What "fully supported" means',
      'A fully supported market gets local currency display and checkout, payment methods that people in that market actually use, and storage in a nearby region so pages and cards load quickly. It is the difference between technically working and genuinely feeling built for a place.',
      '## Payments that fit the market',
      'Alongside card payments, supported markets can accept the local rails their attendees expect — mobile money and regional processors included. Organizers can run free and paid registrations side by side on the same event, in the currency their audience thinks in.',
      '## More to come',
      'This is a step, not a finish line. We are adding markets based on where organizers are already running events, so if your country is not on the list yet, tell us — demand is how we prioritize what comes next.',
    ],
  },
];
