...
const POSTS = [
  ...
  },
  {
    ...
    excerpt: 'We analysed share patterns across every campaign on Eventera. Two things consistently predict whether a card gets shared or sits in a download folder.',
    readTime: '8 min read',
