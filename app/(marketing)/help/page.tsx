...
function LegalTab() {
  ...
  const PRIVACY = [
    { title: 'Overview', body: 'Eventera is an event management platform operated by Eventera. We collect information you provide when creating events, registering for events, or using our services. This policy explains what we collect, why, and how you can control it.' },
