...
const TABS = [
  {
    ...
    blurb:
      'Every speaker, sponsor, and attendee gets their own branded variant of your event card — one design, multiple roles, one link per segment.',
    ...
    examples: [
      {
        ...
        badge: "I'M SPEAKING AT",
        name: 'Kwame Mensah',
        role: 'Product Engineer · Paystack',
        date: '12 MAR 2026 · LAGOS',
      },
      {
  ...
  },
  {
    ...
    blurb:
      'Your supporters announce they\'re backing your cause — branded to your campaign. One link shared in a WhatsApp group becomes hundreds of authentic posts.',
    ...
    examples: [
      {
        ...
        badge: "I'M SUPPORTING",
        name: 'Liya Tesfaye',
        role: 'Campaign Lead',
        date: 'OCT 2025 · ADDIS ABABA',
      },
      {
        event: 'Pan-African Climate Summit',
        badge: "I'M PLEDGING",
        name: 'Omar Diallo',
  ...
  },
  {
    id: 'political',
    label: 'Political',
    icon: <Vote size={15} strokeWidth={1.8} />,
    headline: 'Endorsement and rally cards.',
    blurb:
      'Volunteers, endorsers, and supporters generate cards that look professional and personal at once — consistent branding across thousands of organic posts.',
    ...
    examples: [
      {
        event: 'National Youth Rally 2026',
        badge: "I'M VOTING",
        name: 'Fatima Hassan',
        role: 'Community Organizer',
        date: 'MAR 2026 · NAIROBI',
      },
      {
        event: 'Change Campaign',
        badge: "I ENDORSE",
        name: 'James Mwangi',
        role: 'Ward Representative',
        date: 'APR 2026 · KAMPALA',
      },
    ],
  },
  {
    id: 'religious',
    label: 'Religious',
    icon: <Church size={15} strokeWidth={1.8} />,
    headline: 'Event registration and community drives.',
    blurb:
      'Members announce attendance at your conference, fast, or fundraiser. Cards respect your visual identity and go straight to WhatsApp Status.',
    ...
    examples: [
      {
        event: 'Global Halal Summit 2026',
        badge: "I'M ATTENDING",
      ...
      {
        event: 'East Africa Christian Forum',
        badge: "I'M PARTICIPATING",
        name: 'Samuel Kipkoech',
        role: 'Youth Pastor',
        date: 'JUN 2026 · KIGALI',
      },
    ],
  },
  {
    ...
    blurb:
      'Your customers and partners share branded launch announcements that drive real organic reach — all from one design your team uploads once.',
    ...
    examples: [
      {
        event: 'MTN Brand Activation 2026',
        badge: "I'M PART OF",
        name: 'Ife Adeyemi',
      ...
      {
        event: 'Safaricom Product Launch',
        badge: "I'M LAUNCHING",
        name: 'Wanjiru Kariuki',
        role: 'Product Team',
        date: 'APR 2026 · NAIROBI',
      },
    ],
  },
  {
    id: 'education',
    label: 'Education',
    icon: <GraduationCap size={15} strokeWidth={1.8} />,
    headline: 'Graduations, alumni, and scholarship campaigns.',
    blurb:
      'Graduates, alumni, and scholarship recipients each get their own moment to share — on the day that matters most to them.',
    ...
    examples: [
      {
        event: 'University of Nairobi Class of 2026',
        badge: "I'M GRADUATING",
        name: 'Diana Otieno',
        role: 'BSc Computer Science',
        date: 'JUL 2026 · NAIROBI',
      },
      {
        event: 'ALX Africa Scholarship',
        badge: "I'M A SCHOLAR",
...
function CardMock({ example, color }: { example: (typeof TABS)[0]['examples'][0]; color: string }) {
  return (
    <div
      className="rounded-2xl overflow-hidden w-full max-w-[220px] shrink-0"
      style={{ background: color, boxShadow: '0 8px 24px rgba(15,31,24,0.2)' }}
    >
      <div className="p-4">
        <div className="font-mono text-[8px] tracking-[0.2em] text-white/60 uppercase mb-2">
          {example.event}
        </div>
        <div className="font-mono text-[9px] tracking-[0.14em] text-white/90 uppercase mb-3 border border-white/20 inline-block px-2 py-0.5 rounded-full">
          {example.badge}
        </div>
        <div className="flex items-center gap-2 mt-3">
          <div className="h-8 w-8 rounded-full bg-white/20 shrink-0 grid place-items-center">
            <span className="text-[9px] font-bold text-white">{example.name.split(' ').map(w => w[0]).join('')}</span>
          </div>
          <div>
        ...
        <div className="mt-3 pt-3 border-t border-white/10 font-mono text-[8px] text-white/50">
          {example.date}
        </div>
      </div>
    </div>
  ...
  return (
    <>
        ...
        >
          ...
          <div className="p-8 lg:p-10 flex flex-col lg:flex-row gap-8 lg:gap-12 items-start" style={{ background: tab.color }}>
            <div className="flex-1">
              ...
              <p className="mt-3 text-[16px] text-white/75 leading-relaxed max-w-[480px]">
                {tab.blurb}
              </p>
            </div>
      ...
      <section className="max-w-[1240px] mx-auto px-6 pb-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {TABS.map(t => (
            ...
            >
              <div className="mb-2" style={{ color: active === t.id ? '#E8C57E' : '#1F4D3A' }}>{t.icon}</div>
      ...
      <section className="max-w-[1240px] mx-auto px-6 pb-28">
        <div
          className="rounded-3xl p-10 lg:p-14 flex flex-col sm:flex-row items-center justify-between gap-8"
