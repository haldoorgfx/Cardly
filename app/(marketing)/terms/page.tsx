      ...
      <section className="max-w-[820px] mx-auto px-6 pt-20 pb-28">
        ...
        <div className="space-y-10 text-[16px] text-brand-ink/75 leading-[1.8]">
          <section>
            ...
            <p>
              By creating an account or using Karta, you agree to these terms.
              If you&apos;re using Karta on behalf of an organization, you
          ...
          <section>
            ...
            <p>
              Karta is a tool that lets designers upload event card designs and
          ...
          <section>
            ...
            <p className="mb-3">You may not use Karta to:</p>
            <ul className="list-disc pl-5 space-y-1.5 text-[15px]">
              <li>
          ...
          <section>
            ...
            <p>
              ...
              to Karta, you keep full ownership. We don&apos;t claim any rights
              to your artwork, brand assets, or design files.
            </p>
            <p className="mt-3">
              <strong>The platform is ours.</strong> The Karta software, editor,
              and infrastructure belong to us. You may not copy, reverse-engineer,
              or redistribute any part of the platform.
            </p>
            <p className="mt-3">
              By uploading a design, you grant Karta a limited license to
          ...
          <section>
            ...
            <p>
              Karta is provided &ldquo;as is.&rdquo; We try hard to keep it
            ...
            <p className="mt-3">
              ...
              generated by Karta. You are responsible for ensuring the designs
