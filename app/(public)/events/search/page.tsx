...
export default async function SearchPage({ searchParams }: Props) {
  ...
  let query = (admin as any)
    .from('event_pages')
    .select('id, event_id, title, tagline, cover_image_url, starts_at, ends_at, timezone, is_online, venue_name, venue_lat, venue_lng, city, country, category, price_from, organizer_name, custom_slug, events!event_id(slug, user_id)')
    .eq('is_public', true)
