...
export default async function EventPageEditor({ params }: Props) {
      ...
      <div className="max-w-[800px] mx-auto px-6 py-8">
        <div className="mb-6">
          ...
          <p className="text-[14px] mt-1" style={{ color: '#6B7A72' }}>
            Edit your public event page — cover image, description, venue, and dates.
          </p>
        </div>
        {/* Phase 1.2 — full editor built here */}
        <div
          className="rounded-2xl flex items-center justify-center py-20 text-center"
          style={{ background: 'white', border: '1px solid #E5E0D4' }}
        >
          <div>
            <div className="font-mono text-[11px] tracking-widest uppercase mb-2" style={{ color: '#6B7A72' }}>Phase 1.2</div>
            <div className="text-[14px]" style={{ color: '#3A4A42' }}>
              Cover image upload · title · description · venue · dates · timezone
            </div>
          </div>
        </div>
      </div>
