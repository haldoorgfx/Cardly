    ...
    <div className="min-h-screen grid" style={{ gridTemplateColumns: '300px 1fr' }}>
      ...
      >
        ...
        <div className="relative flex-1">
          <div className="font-mono text-[10px] tracking-[0.2em] uppercase mb-5" style={{ color: 'rgba(232,197,126,0.8)' }}>
            Get set up
          </div>
            ...
            {STEPS.slice(0, 5).map((s, i) => {
              ...
              return (
                <div key={i} className="flex items-center gap-3 py-2">
                  <span
                    className="w-6 h-6 rounded-full grid place-items-center font-mono text-[11px] shrink-0"
                    style={{
