...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#fafafa] grid place-items-center px-6">
      <div className="text-center max-w-[440px]">
        ...
        <div className="text-[11px] font-mono tracking-widest text-[#0f0f1a]/40 mb-4">404</div>
        <h1 className="font-display font-bold text-[36px] leading-tight">Page not found.</h1>
        <p className="text-[15px] text-[#0f0f1a]/60 mt-3 leading-relaxed">
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          ...
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 h-11 px-6 rounded-xl border border-[#e5e5ea] text-[14px] font-medium hover:bg-white transition"
          >
            Dashboard
          </Link>
        </div>
