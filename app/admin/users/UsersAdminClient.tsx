...
import { Search, Loader2, AlertTriangle, Ban, Trash2, RotateCcw, ChevronRight } from 'lucide-react';
          ...
          <table className="w-full text-[13px]">
            ...
            <tbody className="bg-white divide-y divide-[#E5E0D4]">
              {users.map(u => {
                ...
                return (
                  <tr key={u.id} className={`hover:bg-[#FAF6EE]/60 transition-colors ${u.suspended ? 'opacity-60' : ''}`}>
