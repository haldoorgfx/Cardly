...
const PLATFORM_NAV = [
  ...
  },
  {
    ...
    requireRole: "admin",
    items: [
      { id: "cms-pages", label: "Pages & Content", icon: "Layout", screen: "page" },
      { id: "cms-pricing", label: "Plans & Pricing", icon: "CreditCard", screen: "page" },
      { id: "cms-appearance", label: "Appearance", icon: "Palette", screen: "page" },
      { id: "cms-emails", label: "Email Templates", icon: "Bell", screen: "page" },
      { id: "cms-announcements", label: "Announcements", icon: "Sparkle", screen: "page" },
      { id: "cms-navigation", label: "Navigation & Features", icon: "Grid", screen: "page" },
    ],
  },
  {
    title: "Operations",
...
const EVENT_NAV = [
  {
    ...
    items: [
      ...
      { id: "orders", label: "Orders", icon: "CreditCard", screen: "page" },
      { id: "registrations", label: "Registrations", icon: "Users", screen: "page" },
      { id: "waitlist", label: "Waitlist", icon: "Clock", screen: "page" },
      { id: "check-in", label: "Check-in", icon: "Scan", screen: "page" },
      { id: "badges", label: "Badges", icon: "IdCard", screen: "page" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "call-for-speakers", label: "Call for Speakers", icon: "TypeT", screen: "page" },
    ],
  },
  {
    title: "Engagement",
    items: [
      ...
      { id: "meetings", label: "1:1 Meetings", icon: "Calendar", minPlan: "pro", screen: "page" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "floor-plan", label: "Floor Plan", icon: "Grid", minPlan: "studio", screen: "page" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "reports", label: "Reports", icon: "ListChecks", screen: "page" },
    ],
  },
  {
    title: "Configure",
...
const EVENT_CARDS = [
  ...
  { id: "orders", label: "Orders", icon: "CreditCard", desc: "Transactions, receipts and refunds", status: "$4.2k · 178 orders", screen: "page" },
  { id: "badges", label: "Badges", icon: "IdCard", desc: "Design & print on-site name badges", status: "4 variants", screen: "page" },
  { id: "meetings", label: "1:1 Meetings", icon: "Calendar", desc: "Attendee meeting scheduler", minPlan: "pro", status: "92 booked", screen: "page" },
