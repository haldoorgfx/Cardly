...
const Icon = {
  ...
  Palette: (p) => (
    <I {...p}>
      <path d="M12 3a9 9 0 1 0 0 18c1.2 0 2-.9 2-2 0-1.3-1-1.7-1-2.7 0-.7.6-1.3 1.3-1.3H17a4 4 0 0 0 4-4c0-4.4-4-8-9-8z" />
      <circle cx="7.5" cy="11" r="1" fill="currentColor" sw={0} />
      <circle cx="10.5" cy="7.5" r="1" fill="currentColor" sw={0} />
      <circle cx="15" cy="8" r="1" fill="currentColor" sw={0} />
    </I>
  ),
  CreditCard: (p) => (
    <I {...p}>
  ...
  Puzzle: (p) => (
    <I {...p}>
      <path d="M9 4a1.5 1.5 0 0 1 3 0c0 .6-.3 1 0 1.3.3.3.7.2 1.2.2H16a1 1 0 0 1 1 1v2.3c0 .5-.1.9.2 1.2.3.3.7 0 1.3 0a1.5 1.5 0 0 1 0 3c-.6 0-1-.3-1.3 0-.3.3-.2.7-.2 1.2V18a1 1 0 0 1-1 1h-2.3c-.5 0-.9.1-1.2-.2-.3-.3 0-.7 0-1.3a1.5 1.5 0 0 0-3 0c0 .6.3 1 0 1.3-.3.3-.7.2-1.2.2H6a1 1 0 0 1-1-1v-2.3c0-.5.1-.9-.2-1.2-.3-.3-.7 0-1.3 0a1.5 1.5 0 0 1 0-3c.6 0 1 .3 1.3 0 .3-.3.2-.7.2-1.2V7a1 1 0 0 1 1-1h2.3c.5 0 .9-.1 1.2.2.3.3 0 .7 0 1.3" />
    </I>
  ),
  Tag: (p) => (
    <I {...p}>
      <path d="M3 11.5V5a2 2 0 0 1 2-2h6.5a2 2 0 0 1 1.4.6l7 7a2 2 0 0 1 0 2.8l-6.5 6.5a2 2 0 0 1-2.8 0l-7-7A2 2 0 0 1 3 11.5z" />
      <circle cx="7.5" cy="7.5" r="1.4" fill="currentColor" sw={0} />
    </I>
  ),
  Shield: (p) => (
    <I {...p}>
  ...
  Dollar: (p) => (
    <I {...p}>
      <path d="M12 2v20M16.5 6.5C16 5 14.5 4 12 4 9 4 7.5 5.5 7.5 7.5S9.5 11 12 11s4.5 1.5 4.5 3.5S15 18 12 18c-2.5 0-4-1-4.5-2.5" />
    </I>
  ),

  // ── Studio / editor icons ───────────────────────────────────────
  Undo: (p) => <I {...p}><path d="M9 7L4 12l5 5M4 12h11a5 5 0 0 1 0 10h-3" /></I>,
  Redo: (p) => <I {...p}><path d="M15 7l5 5-5 5M20 12H9a5 5 0 0 0 0 10h3" /></I>,
  Eye: (p) => <I {...p}><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z" /><circle cx="12" cy="12" r="3" /></I>,
  Play: (p) => <I {...p} fill="currentColor" sw={0} d="M7 4.5v15l13-7.5z" />,
  Globe: (p) => <I {...p}><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3a14 14 0 0 1 0 18M12 3a14 14 0 0 0 0 18" /></I>,
  Help: (p) => <I {...p}><circle cx="12" cy="12" r="9" /><path d="M9.5 9.5a2.5 2.5 0 1 1 3.4 2.3c-.8.3-1.4 1-1.4 1.9v.3" /><circle cx="12" cy="17" r="0.6" fill="currentColor" sw={0} /></I>,
  Copy: (p) => <I {...p}><rect x="9" y="9" width="11" height="11" rx="2" /><path d="M5 15V5a2 2 0 0 1 2-2h8" /></I>,
  Trash: (p) => <I {...p}><path d="M4 7h16M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2M6 7l1 13a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1l1-13" /></I>,
  TypeT: (p) => <I {...p}><path d="M5 5h14M12 5v14M9 19h6" /></I>,
  ImageZone: (p) => <I {...p}><rect x="3" y="5" width="18" height="14" rx="2" /><circle cx="9" cy="11" r="2" /><path d="M21 17l-5-5-4 4-2-2-4 4" /></I>,
  SelectField: (p) => <I {...p}><rect x="3" y="6" width="18" height="12" rx="2" /><path d="M14 10l2 2 2-2" /></I>,
  Upload: (p) => <I {...p}><path d="M12 16V4M8 8l4-4 4 4M5 16v2a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-2" /></I>,
  Square: (p) => <I {...p}><rect x="4" y="4" width="16" height="16" rx="2" /></I>,
  AlignLeft: (p) => <I {...p} d="M4 6h16M4 12h10M4 18h13" />,
  AlignCenter: (p) => <I {...p} d="M4 6h16M7 12h10M5 18h14" />,
  AlignRight: (p) => <I {...p} d="M4 6h16M10 12h10M7 18h13" />,
  AlignJustify: (p) => <I {...p} d="M4 6h16M4 12h16M4 18h16" />,
  Move: (p) => <I {...p}><path d="M12 3v18M3 12h18M9 6l3-3 3 3M9 18l3 3 3-3M6 9l-3 3 3 3M18 9l3 3-3 3" /></I>,
};
